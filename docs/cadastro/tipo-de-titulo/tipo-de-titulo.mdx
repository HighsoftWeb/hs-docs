...
## Como cadastrar um tipo de titulo?

Para conseguir criar um tipo de título devemos ir no caminho <highlight bgColor="#54638c">Cadastro > Financeiro > Tipo de Títulos</highlight>. <br/> [Não encontrei esse menu](/docs/intro/comecando#não-encontrei-o-menu-desejado)
