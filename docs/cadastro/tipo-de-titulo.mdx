...
Os Tipos de Títulos são usados no campo **TIPO** localizado no cabeçalho dos orçamentos, notas de entrada, títulos a pagar e títulos a receber. Após este ser utilizado em algum desses campos seguindo de uma gravação ou processamento da tela utilizada o sistema o sistema geraria um movimento de caixa ou algum informativo financeiro para pagamento posterior de clientes ou fornecedores em nome dos mesmos listados.
