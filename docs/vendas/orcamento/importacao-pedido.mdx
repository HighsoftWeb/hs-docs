...
Para importar um pedido, você deve ir no caminho <highlight bgColor="#54638c">Diversos > Exportação Importação > Importação do HsMovel</highlight>. <br/> [Não encontrei esse menu](../../intro/comecando#não-encontrei-o-menu-desejado)
...
:::info
Saiba mais: [**O que fazer com Avisos no HSCorp?**](../../geral/utilidades/erros)
:::
...
Temos a explicação de diversos avisos do HSCorp em [O que fazer com Avisos no HSCorp?](../../geral/utilidades/erros#avisos)
