...
Vamos começar contextualizando o HSCorp
...
Encontrar as funcionalidade do sistemas é essencial para usufruir de todo conteúdop disponível para você, e no HSCorp não é diferente, você pode navegar nos menus para encontrar todas as funcionalidades. Nosso menu se encontra na parte superior do sistema:
...
Imagine que você deseja encontrar o menu de [Cadastro de Cidades](../city/#cadastro), você deve seguir a lógica de: <highlight bgColor="#54638c">Cadastro > Gerais > Cidades</highlight>.
...
Você pode **consultar** mais informações de como cadastrar seus menus em _**[Icones da área de trabalho](../customization/desktop-icons)**_
:::
...
<div className="grid-items-list">
  <p>
    <highlight bgColor="#d43131">"Cadastro de C"</highlight> Campo pesquisado;
  </p>
  <p>
    <highlight bgColor="#bf9d04">"Cadastro de Cidades"</highlight> Menu
    Selecionado;
  </p>
  <p>
    <highlight bgColor="#4fb827">"-> Cadastro -> Gerais"</highlight> Rota e
    caminho do Menu Selecionado;
  </p>
</div>
...
Os menus do HSCorp são liberados conforme conversa com o nosso Suporte, caso esteja faltando algum menu que você deseja entre em contato no numero [48 3626-6689](https://wa.me/554836266689?text=Ola%2C+gostaria+de+falar+com+o+Suporte+para+ver+sobre+meus+menus+do+HSCorp).
