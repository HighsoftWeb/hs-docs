...
Imagine que você deseja encontrar o menu de [Cadastro de Cidades](/docs/cadastro/cidade), você deve seguir a lógica de: <highlight bgColor="#54638c">Cadastro > Gerais > Cidades</highlight>.
...
<details>
  ...
  <div className="grid-items-list">
    ...
    <p>
      <shortcut bgColor="#2b99ff">Ctrl + Alt + M</shortcut> Abre a tela de{' '}
      <a href="/docs/consultas/clientes/clientes-sem-movimentos">
        Consulta clientes sem movimentos
      </a>
    </p>
  </div>
</details>
