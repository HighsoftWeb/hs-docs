...
description: Confira como cadastrar uma Condição de Pagamento no HSCorp
authors: [hugo]
date: 2022-12-14T10:00
image: ./image.png
tags: [docs, tutorial, cadastro, cond-pagamento]
keywords: [docs, tutorial, cadastro, cond-pagamento]
---
...
- Criar uma condição de pagamento para uso no sistema;
