...
:::caution
Normalmente o menu para essa consulta vem desabilitado por padrão no sistema para os usuários, caso não encontre esse menu, consulte mais informações em [Não encontrei esse menu](/docs/intro/comecando#não-encontrei-o-menu-desejado)
:::
