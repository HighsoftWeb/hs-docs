---
slug: como-fazer-devolucao-nota-saida
title: Como fazer a devolução de uma nota de Saída?
authors: [thaise]
...
Abrir a tela de notas fiscais de saída em movimentos no caminho <br/> <highlight bgColor="#54638c">Comercial > Saídas > Notas Fiscais Saída > Movimentos</highlight>. [Não encontrei esse menu](/docs/intro/comecando#não-encontrei-o-menu-desejado)
...
- Se a saída foi feita em série E, Devolução Própria em série E;
- Se a saída foi feita em série C, Devolução em série E;
- Se a saída for feita em Série X, Devolução em Série X;
- Se a saída for feita em Série CF1, Devolução em Série E;
- Se a saída for feita em Série 0, Devolução em Série 0.
...
Ao gravar uma nota de devolução propria de uma nota de saída, irá ocorrer uma movimentação de entrada dos itens ao depósito, e gerará um crédito no financeiro correspondente ao valor da nota
...
Após emitir a nota de devolução própria, ela poderá ser encontrada na tela de consulta de notas de saída, ajustando o filtro `Tipo NF` para **Devolução/Ajuste Devolução**
